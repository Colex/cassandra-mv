...
public class CfDef implements org.apache.thrift.TBase<CfDef, CfDef._Fields>, java.io.Serializable, Cloneable, Comparable<CfDef> {
  ...
  private static final org.apache.thrift.protocol.TField IS_VIEW_FIELD_DESC = new org.apache.thrift.protocol.TField("is_view", org.apache.thrift.protocol.TType.MAP, (short)43);
  private static final org.apache.thrift.protocol.TField VIEW_PROPERTIES_FIELD_DESC = new org.apache.thrift.protocol.TField("view_properties", org.apache.thrift.protocol.TType.MAP, (short)44);
  ...
  public Map<String,String> is_view; // optional
  public Map<String,List<String>> view_properties; // optional
  /**
   * @deprecated
   */
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    IS_VIEW((short)43, "is_view"),
    VIEW_PROPERTIES((short)44, "view_properties"),
    /**
     * @deprecated
     */
  ...
  static {
    ...
    tmpMap.put(_Fields.SPECULATIVE_RETRY, new org.apache.thrift.meta_data.FieldMetaData("speculative_retry", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.IS_VIEW, new org.apache.thrift.meta_data.FieldMetaData("is_view", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING), 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    tmpMap.put(_Fields.VIEW_PROPERTIES, new org.apache.thrift.meta_data.FieldMetaData("view_properties", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING), 
            new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)))));
...
;
    ...
    if (other.isSetIs_view()) {
      Map<String,String> __this__is_view = new HashMap<String,String>(other.is_view);
      this.is_view = __this__is_view;
    }
    if (other.isSetView_properties()) {
      Map<String,List<String>> __this__view_properties = new HashMap<String,List<String>>(other.view_properties.size());
      for (Map.Entry<String, List<String>> other_element : other.view_properties.entrySet()) {

        String other_element_key = other_element.getKey();
        List<String> other_element_value = other_element.getValue();

        String __this__view_properties_copy_key = other_element_key;

        List<String> __this__view_properties_copy_value = new ArrayList<String>(other_element_value);

        __this__view_properties.put(__this__view_properties_copy_key, __this__view_properties_copy_value);
      }
      this.view_properties = __this__view_properties;
    }
  ...
  public int getIs_viewSize() {
    return (this.is_view == null) ? 0 : this.is_view.size();
  }

  public void putToIs_view(String key, String val) {
    if (this.is_view == null) {
      this.is_view = new HashMap<String,String>();
    }
    this.is_view.put(key, val);
  }

  public Map<String,String> getIs_view() {
    return this.is_view;
  }

  public CfDef setIs_view(Map<String,String> is_view) {
  ...
  public int getView_propertiesSize() {
    return (this.view_properties == null) ? 0 : this.view_properties.size();
  }

  public void putToView_properties(String key, List<String> val) {
    if (this.view_properties == null) {
      this.view_properties = new HashMap<String,List<String>>();
    }
    this.view_properties.put(key, val);
  }

  public Map<String,List<String>> getView_properties() {
    return this.view_properties;
  }

  public CfDef setView_properties(Map<String,List<String>> view_properties) {
    this.view_properties = view_properties;
    return this;
  }

  public void unsetView_properties() {
    this.view_properties = null;
  }

  /** Returns true if field view_properties is set (has been assigned a value) and false otherwise */
  public boolean isSetView_properties() {
    return this.view_properties != null;
  }

  public void setView_propertiesIsSet(boolean value) {
    if (!value) {
      this.view_properties = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case IS_VIEW:
      if (value == null) {
        ...
        setIs_view((Map<String,String>)value);
      }
      break;

    case VIEW_PROPERTIES:
      if (value == null) {
        unsetView_properties();
      } else {
        setView_properties((Map<String,List<String>>)value);
      }
      break;
  ...
  public boolean equals(CfDef that) {
    ...
    boolean this_present_is_view = true && this.isSetIs_view();
    boolean that_present_is_view = true && that.isSetIs_view();
    if (this_present_is_view || that_present_is_view) {
      if (!(this_present_is_view && that_present_is_view))
        return false;
      if (!this.is_view.equals(that.is_view))
        return false;
    }

    boolean this_present_view_properties = true && this.isSetView_properties();
    boolean that_present_view_properties = true && that.isSetView_properties();
    if (this_present_view_properties || that_present_view_properties) {
      if (!(this_present_view_properties && that_present_view_properties))
        return false;
      if (!this.view_properties.equals(that.view_properties))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_is_view = true && (isSetIs_view());
    builder.append(present_is_view);
    if (present_is_view)
      builder.append(is_view);

    boolean present_view_properties = true && (isSetView_properties());
    builder.append(present_view_properties);
    if (present_view_properties)
      builder.append(view_properties);
  ...
  public int compareTo(CfDef other) {
    ...
    lastComparison = Boolean.valueOf(isSetIs_view()).compareTo(other.isSetIs_view());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_view()) {
    ...
    lastComparison = Boolean.valueOf(isSetView_properties()).compareTo(other.isSetView_properties());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetView_properties()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.view_properties, other.view_properties);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetView_properties()) {
      ...
      if (this.view_properties == null) {
        ...
        sb.append(this.view_properties);
      }
      first = false;
    }
    if (isSetRow_cache_size()) {
  ...
  private static class CfDefStandardScheme extends StandardScheme<CfDef> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.is_view = new HashMap<String,String>(2*_map103.size);
                for (int _i104 = 0; _i104 < _map103.size; ++_i104)
                {
                  ...
                  struct.is_view.put(_key105, _val106);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.view_properties = new HashMap<String,List<String>>(2*_map107.size);
                for (int _i108 = 0; _i108 < _map107.size; ++_i108)
                {
                  ...
                  struct.view_properties.put(_key109, _val110);
                }
                iprot.readMapEnd();
              }
              struct.setView_propertiesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CfDef struct) throws org.apache.thrift.TException {
      ...
      if (struct.column_metadata != null) {
        if (struct.isSetColumn_metadata()) {
          oprot.writeFieldBegin(COLUMN_METADATA_FIELD_DESC);
          {
            ...
            for (ColumnDef _iter114 : struct.column_metadata)
            {
      ...
      if (struct.compaction_strategy_options != null) {
        if (struct.isSetCompaction_strategy_options()) {
          oprot.writeFieldBegin(COMPACTION_STRATEGY_OPTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter115 : struct.compaction_strategy_options.entrySet())
            {
      ...
      if (struct.compression_options != null) {
        if (struct.isSetCompression_options()) {
          oprot.writeFieldBegin(COMPRESSION_OPTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter116 : struct.compression_options.entrySet())
            {
      ...
      if (struct.is_view != null) {
        if (struct.isSetIs_view()) {
          oprot.writeFieldBegin(IS_VIEW_FIELD_DESC);
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, struct.is_view.size()));
            for (Map.Entry<String, String> _iter117 : struct.is_view.entrySet())
            {
      ...
      if (struct.view_properties != null) {
        if (struct.isSetView_properties()) {
          oprot.writeFieldBegin(VIEW_PROPERTIES_FIELD_DESC);
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.LIST, struct.view_properties.size()));
            for (Map.Entry<String, List<String>> _iter118 : struct.view_properties.entrySet())
            {
  ...
  private static class CfDefTupleScheme extends TupleScheme<CfDef> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, CfDef struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetColumn_metadata()) {
        {
          ...
          for (ColumnDef _iter120 : struct.column_metadata)
          {
      ...
      if (struct.isSetCompaction_strategy_options()) {
        {
          ...
          for (Map.Entry<String, String> _iter121 : struct.compaction_strategy_options.entrySet())
          {
      ...
      if (struct.isSetCompression_options()) {
        {
          ...
          for (Map.Entry<String, String> _iter122 : struct.compression_options.entrySet())
          {
      ...
      if (struct.isSetIs_view()) {
        {
          oprot.writeI32(struct.is_view.size());
          for (Map.Entry<String, String> _iter123 : struct.is_view.entrySet())
          {
      ...
      if (struct.isSetView_properties()) {
        {
          oprot.writeI32(struct.view_properties.size());
          for (Map.Entry<String, List<String>> _iter124 : struct.view_properties.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, CfDef struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.column_metadata = new ArrayList<ColumnDef>(_list126.size);
          for (int _i127 = 0; _i127 < _list126.size; ++_i127)
          {
            ColumnDef _elem128;
            _elem128 = new ColumnDef();
            _elem128.read(iprot);
            struct.column_metadata.add(_elem128);
          }
        }
        struct.setColumn_metadataIsSet(true);
      }
      ...
      if (incoming.get(15)) {
        {
          org.apache.thrift.protocol.TMap _map129 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.compaction_strategy_options = new HashMap<String,String>(2*_map129.size);
          for (int _i130 = 0; _i130 < _map129.size; ++_i130)
          {
            ...
            struct.compaction_strategy_options.put(_key131, _val132);
          }
        }
        struct.setCompaction_strategy_optionsIsSet(true);
      }
      if (incoming.get(16)) {
        {
          org.apache.thrift.protocol.TMap _map133 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.compression_options = new HashMap<String,String>(2*_map133.size);
          for (int _i134 = 0; _i134 < _map133.size; ++_i134)
          {
            ...
            struct.compression_options.put(_key135, _val136);
          }
        }
        struct.setCompression_optionsIsSet(true);
      }
      ...
      if (incoming.get(25)) {
        {
          org.apache.thrift.protocol.TMap _map137 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.is_view = new HashMap<String,String>(2*_map137.size);
          for (int _i138 = 0; _i138 < _map137.size; ++_i138)
          {
            ...
            struct.is_view.put(_key139, _val140);
          }
        }
        struct.setIs_viewIsSet(true);
      }
      if (incoming.get(26)) {
        {
          ...
          struct.view_properties = new HashMap<String,List<String>>(2*_map141.size);
          for (int _i142 = 0; _i142 < _map141.size; ++_i142)
          {
            ...
            struct.view_properties.put(_key143, _val144);
          }
        }
        struct.setView_propertiesIsSet(true);
      }
